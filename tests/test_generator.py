...
ALL_TEST_SPECIFICATIONS = [
    ...
    "tests/resources/datePropertyTest.json",
    ...
    "tests/resources/long_description_issue_7839.json",
    "tests/resources/markdown.yaml",
    # "tests/resources/pathWithHtmlEntity.yaml",
    "tests/resources/petstore-bash.json",
    # "tests/resources/petstore-for-samples-servers.yaml",
    # "tests/resources/petstore_issue_7999.json",
    ...
    # "tests/resources/swift4Test.json",
